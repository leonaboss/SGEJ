...
DESCRIPCIONES_POR_ACCION = {
    ...
    'BLOQUEO_USUARIO': 'Cambio de estado de bloqueo de usuario',
    'EXPORTACION': 'Exportación de reporte a Excel',
    'IMPORTACION': 'Importación masiva de datos',
    'SUBIDA': 'Carga de archivo',
